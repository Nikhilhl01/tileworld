"""
Django settings for tileworld project.
...
SECRET_KEY = 'django-insecure-dr^enuls4l9_a@v&*^1+pvg&@glh75nt72tsn&wnz2msu%jmt2'
...
WSGI_APPLICATION = 'tileworld.wsgi.application'
